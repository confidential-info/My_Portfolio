        ...
        <div className="hero-img">
            <div>
                <div className="tech-icon">
                    <svg class="w-[48px] h-[48px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="72" height="72" fill="currentColor" viewBox="0 0 24 24">
                ...
                <img src="./assets/Tomioka.jpg" alt="Image" width={550} /> 
            </div>
            <div>
                <div className="tech-icon">
                    <svg class="w-[48px] h-[48px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="72" height="72" fill="currentColor" viewBox="0 0 24 24">
