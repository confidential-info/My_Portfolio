        ...
        <div className="hero-img">
            <div>
                <div className="tech-icon">
                    <svg class="w-[48px] h-[48px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="72" height="72" fill="lightblue" viewBox="0 0 24 24">
            ...
            <div>
                <div className="tech-icon">
                    <svg class="w-[48px] h-[48px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="72" height="72" fill="orange" viewBox="0 0 24 24">
                ...
                <div className="tech-icon">
                    <svg class="w-[48px] h-[48px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="72" height="72" fill="blue" viewBox="0 0 24 24">
